      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-unir-dark-blue mb-6">
            Conheça a <span className="text-unir-orange">Unir</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16 max-w-4xl mx-auto">
          {founders.map((founder, index) => (
            <div key={index} className="text-center card-gradient p-8 rounded-2xl shadow-card hover:shadow-elegant transition-smooth">
              ...
              <p className="text-unir-orange font-medium mb-4">{founder.role}</p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-8">
            <div className="w-16 h-16 bg-unir-orange rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="text-center p-8">
            <div className="w-16 h-16 bg-unir-light-green rounded-full flex items-center justify-center mx-auto mb-6">
              <Users className="w-8 h-8 text-unir-dark-blue" />
            </div>
